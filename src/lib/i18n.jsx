...
const en = {
  ...
  nav: {
    home: "Home",
    how: "How It Works",
    victims: "For Victims & Families",
    officials: "For Officials",
    command: "National monitoring",
    resources: "Resources",
    contact: "Contact",
    helpline: "Helpline 14566",
    exit: "Exit",
  ...
  stats: {
    ...
    items: [
      ...
      { n: 45, suffix: "", label: "median days to first counselling contact — where one happens at all" },
...
const hi = {
  ...
  nav: {
    ...
    victims: "पीड़ितों व परिवारों के लिए",
    officials: "अधिकारियों के लिए",
    command: "राष्ट्रीय निगरानी",
    resources: "संसाधन",
    contact: "संपर्क",
    helpline: "हेल्पलाइन 14566",
  ...
  stats: {
    ...
    items: [
      ...
      { n: 45, suffix: "", label: "पहले परामर्श तक पहुँचने में लगते हैं औसतन इतने दिन — जहाँ परामर्श होता भी है" },
