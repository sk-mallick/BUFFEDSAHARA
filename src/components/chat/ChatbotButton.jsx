...
export default function ChatbotButton({ onOpen }) {
  ...
  return (
    <motion.button
      ...
      className="chat-pulse fixed bottom-5 right-4 z-drawer flex h-14 w-14 items-center justify-center rounded-full bg-[var(--chat-primary)] text-white shadow-4 transition-colors duration-base hover:bg-[var(--chat-primary-hover)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink-900 active:scale-95 sm:bottom-6 sm:right-6"
    >
