...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-sand-200 bg-white text-ink-900 shadow-1 transition-all",
      className
    )}
    {...props}
  />
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-display text-xl font-semibold leading-tight tracking-tight text-ink-900",
      className
    )}
    {...props}
  />
